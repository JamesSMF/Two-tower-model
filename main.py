...
def train(x, y, x_val=None, y_val=None):
    ...
    trainable = DSSMTrainable(x, y, col_params, batch_size=opt.batch_size, shuffle=opt.shuffle,
                              ...
                              val_x=x_val, val_y=y_val, neg_sampling=opt.neg_sampling)
...
def test(x, y, model_path):
    trainable = DSSMTrainable(x, y, batch_size=opt.batch_size, model_path=model_path, neg_sampling=opt.neg_sampling)
